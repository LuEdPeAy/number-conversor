...
<div class="card text-center">
  <div class="card-header">
    Convertidor Decimal a Octal
  </div>
  <div class="card-body">
    <h5 class="card-title">Decimal a Octal</h5>
    <p class="card-text">Simple convertidor de práctica de números enteros decimales a Octal.</p>
  </div>
  <div class="container">
